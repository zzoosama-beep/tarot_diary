...
class LayoutTokens {
  ...
  // ✅ [변경] 하단 버튼(CTA)이 바닥에 너무 붙어 보여서 더 위로 올림
  // - 기존 24.0 → 44.0 (필요하면 36~56 사이에서 취향대로)
  ...
  // ✅ [변경] bottomBottomPad 올린 만큼 스페이서도 같이 올려서
  // 스크롤 컨텐츠가 하단 CTA에 덜 “닿게” 안정화
  static const double scrollBottomSpacer = 116.0; // 기존 96.0 → 116.0
