                            ...
                            children: [
                              ...
                              _HomeBigPanel(
                                ...
                                leftAction: _HomeActionCardData(
                                  ...
                                  onTap: () {
                                    Navigator.of(context).push(
                                      _fadeRoute(const WriteArcanaPage()),
                                    );
                                  },
                                ),
                                rightAction: _HomeActionCardData(
                                  ...
                                  onTap: () {
                                    Navigator.of(context).push(
                                      _fadeRoute(const ListArcanaPage()),
                                    );
                                  },
                                ),
                              ),
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      data.label,
                      maxLines: 2, // ✅ 넘침 방지(원본처럼 2줄까지만)
                      overflow: TextOverflow.ellipsis,
                      style: GoogleFonts.gowunDodum(
                        fontSize: 13.4, // ✅ 원본 느낌(조금 낮춰서 안전)
                        fontWeight: FontWeight.w900,
                        color: ink,
                        height: 1.15,
                        letterSpacing: -0.2,
      ...
      child: Stack(
        ...
        children: [
          ...
          const Positioned(
            ...
            right: -10,
            child:
            Icon(Icons.star_outline, size: 10, color: Color(0xFFF3E5AB)),
          ),
        ],
      ),
    );
